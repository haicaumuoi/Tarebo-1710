...
import Reviewing from '~/features/User/Reviewing';
import ReviewingDetail from '~/features/User/ReviewingDetail';
...
const publicRoutes = {
  ...
  [ROLE.user]: [
    ...
    {
      type: ROUTES_TYPE.public,
      path: ROUTES_PATH.user.reviewing,
      component: Reviewing,
      layout: DefaultLayout,
    },
    {
      type: ROUTES_TYPE.public,
      path: ROUTES_PATH.user.reviewingDetail,
      component: ReviewingDetail,
      layout: DefaultLayout,
    },
  ],
  [ROLE.admin]: [
